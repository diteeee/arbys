<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="arbys.User.Contact" %>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                            ...
                            <div>
                                ...
                                <asp:RequiredFieldValidator ID="rvfEmail" runat="server" ErrorMessage="Email is required" ControlToValidate="txtEmail"
                                    ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <asp:RequiredFieldValidator ID="rfvMessage" runat="server" ErrorMessage="Text Message is required" ControlToValidate="txtMessage"
                                    ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            </div>
                            <div class="btn_box">
